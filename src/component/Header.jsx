        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className='lg:w-[32rem] w-full flex flex-col space-y-6'>
            <div className='text-4xl md:text-5xl font-bold text-[#2e2e2e] lg:text-6xl'>
              Elevate <span className='text-[#f54748]'>Your</span> Online <span className='text-[#f54748]'>Shopping</span> Experience <span className='text-[#Fdc55e]'>Here.</span>
            </div>
            <div className="lg:text-xl text-[#191919] md:text-lg text-base">
              Discover a world where your desires come to life with just a click. Elevate your shopping journey with us – where quality meets convenience, and your satisfaction is our priority.
            </div>
            <div className="flex rounded-full py-2 px-4 justify-between items-center bg-white shadow-md">
              <div className='flex items-center'>
                ...
                <input type="text" placeholder='Search products here...' className='text-[#191919] w-full border-none outline-none py-2 px-4' />
              </div>
          ...
          <img src={header} alt="Header" className='h-[35rem] mx-auto justify-end' />
        </div>
      </div>
    </div>
  );
